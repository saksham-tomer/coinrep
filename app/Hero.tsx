...
const Hero = () => {
  ...
  const titleAnimatedStyle = useAnimatedStyle(() => ({
    ...
    transform: [
      { translateY: withTiming(titleOpacity.value * 0, { duration: 300 }) },
    ],
  }));
  ...
  const descriptionAnimatedStyle = useAnimatedStyle(() => ({
    ...
    transform: [
      {
        translateY: withTiming(descriptionOpacity.value * 0, { duration: 300 }),
      },
    ],
  }));
  ...
  return (
    <SafeAreaView
      className={`${containerPadding} flex items-center justify-center min-h-screen`}
    >
      <View className="items-center flex flex-col">
        ...
        <Animated.Text
          ...
          className={`${titleSize} text-black font-black shadow-lg mt-4`}
        >
          Coiico Wallet
        </Animated.Text>
      </View>
      ...
      >
        <Text
          className={`text-center ${descriptionSize} font-semibold text-gray-500`}
        >
